...
- グローバルショートカット: `Shift` を400ms以内に素早く2回押して離す
...
WPF版はmacOSネイティブ版の操作仕様に合わせ、gantt検索、Tabでのganttメモ画面切替、タスク名・メモ・送信・キャンセル、共有parent取得、パスコピー、保存場所、フォルダ、ganttリンク、GUIボタン、上下キー循環選択を提供します。Windowsの検索性能仕様に従い、gantt未選択時は既存インデックスだけを検索します。
